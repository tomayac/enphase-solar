...
const producingSparklineHourly = document.querySelector(
  '.producing-sparkline-hourly',
);
const consumingSparklineHourly = document.querySelector(
  '.consuming-sparkline-hourly',
);
const importingSparklineHourly = document.querySelector(
  '.importing-sparkline-hourly',
);
const exportingSparklineHourly = document.querySelector(
